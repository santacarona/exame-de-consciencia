...
export const InstructionsScreen: React.FC<InstructionsScreenProps> = ({ onBack }) => {
  return (
    <div className="relative flex h-full w-full flex-col bg-transparent text-parchment overflow-hidden font-display animate-in fade-in duration-500">
      ...
      <div className="absolute inset-0 z-0 opacity-20 pointer-events-none bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-primary/20 via-transparent to-transparent mix-blend-overlay"></div>
      ...
      {/* Main Content */}
      <main className="relative z-10 flex-1 flex flex-col items-center justify-center px-8 w-full max-w-md mx-auto overflow-y-auto scroll-smooth no-scrollbar">
        ...
        <div className="flex flex-col gap-10 w-full items-center">
          ...
          <div className="flex flex-col w-full items-center">
            ...
            <div className="relative h-48 w-full flex items-center justify-center mt-4 select-none">
